...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <nav className="bg-white/95 backdrop-blur-sm border-b border-gray-200 shadow-sm fixed top-0 left-0 right-0 z-40">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 pt-16 relative overflow-hidden">
        ...
        <div className="text-center z-10 max-w-2xl animate-fade-in">
          ...
          <h1 className="text-5xl md:text-7xl font-bold font-display mb-4 text-gray-900">
